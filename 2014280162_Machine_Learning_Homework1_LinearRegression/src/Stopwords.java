...
public class Stopwords {
	...
	public static String[] stopwords = { "a", "as", "able", "about", "above",
			...
			"far", "few", "ff", "fifth", "first", "five", "followed", "for",
			...
			"should", "shouldnt", "since", "six", "so", "some", "somebody",
			...
			"that", "thats", "thats", "the", "their", "theirs", "them",
			"themselves", "then", "thence", "there", "theres", "thereafter",
			"thereby", "therefore", "therein", "theres", "thereupon", "these",
			"they", "theyd", "theyll", "theyre", "theyve", "think", "third",
